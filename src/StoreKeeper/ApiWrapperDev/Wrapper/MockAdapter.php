...
class MockAdapter implements WrapperInterface, LoggerAwareInterface
{
     ...
     * @throws \Exception
     */
    function registeredAction(MockAction $action, bool $overwrite = false)
    {
        $name = $action->getName();
     ...
     * @throws \Exception
     */
    function withAction( $name, callable $call, bool $overwrite = false){
    ...
    /**
     * @param ModuleApiWrapperInterface $module
     * @param bool $overwrite
     *
     * @throws \Exception
     */
    function registeredModuleApiWrapper(ModuleApiWrapperInterface $module, bool $overwrite = false)
    {
     ...
     * @throws \Exception
     */
    function withModule( $name, callable $call ){
     ...
     * @throws \Exception
     */
    function withOriginalModule(ActionWrapperInterface $wrapper,  $name, callable $call = null){
     ...
     * @param bool $matchParams
     *
     * @param DumpFile\Reader|null $reader
     *
     * @throws \Exception
     */
    function registerDumpFile(string $filepath, bool $matchParams = false, DumpFile\Reader $reader = null){
        if( is_null($reader)){
        ...
        if( $type === DumpFile::ACTION_TYPE ){
            ...
            $this->withModule($file->getModuleName(), function (MockInterface $module) use ( $matchParams, $file)   {
